...
import { addQuestion, getCourse } from '../../store/actions/datacollection';
import { saveEditorContent } from './reuseable';

const AddSectionsResuse = (props) => {
...
<p>Add Question to : <span>{props.header}</span></p>
...
<PushSpinner color="aqua" size={17} />
    ...
    :  <Button type='submit' style={{margin:"10px"}}>Add Question</Button>
}
...
export default AddSectionsResuse;
